...
data_acoeffs = GVARS.acoeffs_true - pred_acoeffs
# np.random.seed(3)
...
tdiff = 0
grads = _grad_fn(c_init, GVARS.ctrl_arr_dpt_full*0.0, fixed_part*0.0, data_acoeffs)
loss = _loss_fn(c_init, GVARS.ctrl_arr_dpt_full*0.0, fixed_part*0.0, data_acoeffs)
model_misfit = model_misfit_fn(c_init, GVARS.ctrl_arr_dpt_full*0.0)
data_misfit = loss - mu*model_misfit
...
c_arr = iterative_RLS(c_init, GVARS.ctrl_arr_dpt_full*0.0, fixed_part*0.0, data_acoeffs_iter)
